...
to-report lane-2-avg-vel
  let avg-vel-2 mean [vel] of patches with [pycor = 2 and free = false]
  report avg-vel-2
end

to-report lane-1-avg-vel
  let avg-vel-1 mean [vel] of patches with [pycor = 1 and free = false]
  report avg-vel-1
end

to-report lane-0-avg-vel
  let avg-vel-0 mean [vel] of patches with [pycor = 0 and free = false]
  report avg-vel-0
end
@#$#@#$#@
GRAPHICS-WINDOW
